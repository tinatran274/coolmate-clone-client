        ...
        <div >
            ...
            <div>
                ...
                <div className="flex flex-row mb-10">
                    <Textarea className="mx-8 w-[80%] mt-4" value={contentCmt} onChange={(e) => setContentCmt(e.target.value)} placeholder="Nhập bình luận"
                    />
                    <Button className=" mt-4" onClick={handleAddRating} >Đánh giá</Button >
                </div>
