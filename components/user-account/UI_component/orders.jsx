...
function Orders (props) {
    ...
    const handleGetAllOrder = () => {
        try {
          const options = {
            method: 'GET',
            url: 'https://localhost:7107/api/order/get',
            headers: {
        ...
        <div>
            <div className = {isVisibleDetailOrder? "hidden" : "visible"} >
                ...
                <div className=''>
                    ...
                    return ( <div key={index} onClick={e => handleDetailOrder(index)}> 
                        <CardItemOdrer
                            detaiOrder={responseData[index]} /> </div>
                    )})}
                </div>
            </div>
            <div  className = {isVisibleDetailOrder? "visible":"hidden" } >
                ...
                <div className="flex flex-row mb-2 items-center">
                    ...
                    {currentOrder.orderDate ? <p className='text-sm'>{currentOrder.orderDate}</p> :""}
                </div>
                <div className="flex flex-row mb-2 items-center">
                ...
                <div className="flex flex-row mb-2 items-center">
                    ...
                    {currentOrder ? <p className='text-sm'>
                ...
                <div className="flex flex-row mb-2 items-center">
                    ...
                    {currentOrder.shippingAddress ? <p className='text-sm'>{currentOrder.shippingAddress}</p> :""}
                </div>
                <div className="flex flex-row mb-2 items-center">
                ...
                <div className='bg-gray-200 rounded-b-md rounded-t-xl mt-6'>
                    ...
                    <div className='px-4 pb-2'>
                        {currentOrder.orderLines && currentOrder.orderLines.map((product, index) => {
                        return (
                            <CardItemDetailOrder
                                key={index}
