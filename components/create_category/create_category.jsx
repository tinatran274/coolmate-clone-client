           ...
           <div className="w-[100%] flex flex-row">
                ...
                <div className="w-[65%] p-8">   
                    ...
                    <div className='shadow-md px-8 py-10 mb-6 bg-white rounded-md'>
                        ...
                        <Input className="rounded-full px-4" type="text" placeholder="Nhập tên category" value={categoryName} onChange={handleCategoryNameChange}/>
            ...
            <div className='w-[100%] bg-gray-100 '>
                <Button className='w-[95%] rounded-full p-8 mb-20 ml-8' onClick={handleAddCategory}>Hoàn tất</Button>
            </div>
