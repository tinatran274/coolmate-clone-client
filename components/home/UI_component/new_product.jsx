...
const NewProduct = () => {
    ...
    const response = {
        "pageNumber": 1,
        "pageSize": 10,
        "firstPage": "https://localhost:7107/api/product/Áo các loại?pageNumber=1&pageSize=10",
        "lastPage": "https://localhost:7107/api/product/Áo các loại?pageNumber=2&pageSize=10",
        "totalPages": 2,
        "totalRecords": 18,
        "nextPage": "https://localhost:7107/api/product/Áo các loại?pageNumber=2&pageSize=10",
        "previousPage": null,
        "data": [
            {
              "id": 1,
              ...
              "productItems": [
                {
                  ...
                  "size": "M",
                  "color": "Đen",
                  "colorImage": "https://media.coolmate.me/cdn-cgi/image/width=160,height=160,quality=80,format=auto/uploads/November2023/promax_polo_den113_4.jpg",
                  "qtyInStock": 48,
                  "orderLines": [],
                  "product": null,
                  "productItemImages": [
                ...
                },
                {
                  ...
                  "size": "M",
                  "color": "Xanh Navy",
                  "colorImage": "https://media.coolmate.me/cdn-cgi/image/width=160,height=160,quality=80,format=auto/uploads/November2023/mau_vai_combo-1.jpg",
                  "qtyInStock": 38,
                  "orderLines": [],
                  "product": null,
                  "productItemImages": [
            ...
            },
            {
              ...
              "description": "Thành phần: 100% Polyester | Chất liệu áo khoác thể thao có khả năng giữ ấm | Hạn chế xù lông và chống nhăn | Form áo: Regular, ôm nhẹ | Tự hào sản xuất tại Việt Nam | Người mẫu: 1m77 - 69kg, mặc áo 2XL | ",
              "priceInt": 469000,
              "priceStr": "469.000đ",
              "category": null,
              "productItems": [
                {
                  ...
                  "size": "M",
                  "color": "Xám",
                  "colorImage": "https://media.coolmate.me/cdn-cgi/image/width=160,height=160,quality=80,format=auto/uploads/October2023/2-5a23_79.jpg",
                  "qtyInStock": 33,
                  "orderLines": [],
                  "product": null,
                  "productItemImages": [
                ...
                },
                {
                  ...
                  "size": "M",
                  "color": "Xanh Navy",
                  "colorImage": "https://media.coolmate.me/cdn-cgi/image/width=160,height=160,quality=80,format=auto/uploads/October2023/mau-xanh-navy_38.jpg",
                  "qtyInStock": 25,
                  "orderLines": [],
                  "product": null,
                  "productItemImages": [
                ...
                },
                {
                  ...
                  "size": "M",
                  "color": "Đen",
                  "colorImage": "https://media.coolmate.me/cdn-cgi/image/width=160,height=160,quality=80,format=auto/uploads/October2023/mau-den_33.jpg",
                  "qtyInStock": 46,
                  "orderLines": [],
                  "product": null,
                  "productItemImages": [
            ...
            },
            {
                ...
                "description": "Chất liệu: Nỉ chân cua | Thành phần: 60% Cotton + 40% Polyester | Thoáng khí và thoải mái khi mặc, vẫn giữ ấm cho bạn trong trời thu đông | Hạn chế xù lông, bền màu | Form dáng: Regular, thoải mái | Tự hào sản xuất tại Viêt Nam | ",
                "priceInt": 299000,
                "priceStr": "299.000đ",
                "category": null,
                "productItems": [
                  {
                    ...
                    "size": "M",
                    "color": "Xám sáng",
                    "colorImage": "https://media.coolmate.me/cdn-cgi/image/width=160,height=160,quality=80,format=auto/uploads/October2023/23CMCW.ST002.22.jpg",
                    "qtyInStock": 13,
                    "orderLines": [],
                    "product": null,
                    "productItemImages": [
                  ...
                  },
                  {
                    ...
                    "size": "M",
                    "color": "Đen",
                    "colorImage": "https://media.coolmate.me/cdn-cgi/image/width=160,height=160,quality=80,format=auto/uploads/October2023/23CMCW.ST002.19.jpg",
                    "qtyInStock": 18,
                    "orderLines": [],
                    "product": null,
                    "productItemImages": [
                  ...
                  },
                  {
                    ...
                    "size": "M",
                    "color": "Xanh rêu",
                    "colorImage": "https://media.coolmate.me/cdn-cgi/image/width=160,height=160,quality=80,format=auto/uploads/October2023/23CMCW.ST002.20.jpg",
                    "qtyInStock": 12,
                    "orderLines": [],
                    "product": null,
                    "productItemImages": [
                  ...
                  },
                  {
                    ...
                    "size": "M",
                    "color": "Xám đậm",
                    "colorImage": "https://media.coolmate.me/cdn-cgi/image/width=160,height=160,quality=80,format=auto/uploads/October2023/23CMCW.ST002.21.jpg",
                    "qtyInStock": 39,
                    "orderLines": [],
                    "product": null,
                    "productItemImages": [
    ...
    const handleGetAoCacLoai = () => {
        ...
        //     const options = {
        //         method: 'GET',
        //         url: 'https://localhost:7107/api/product/Áo%20các%20loại',
        //     }   
        //     axios
        //     .request(options)
    ...
    return(
        <div>
            ...
            <div className="grid lg:grid-cols-5 md:grid-cols-3 gap-5 grid-cols-2 pt-[45px] max-w-full px-[30px] mx-auto">
                {responseData.data && responseData.data.map((product, index) => {
                    return (
                        <CardProductTest
                            key = {index}
                            product = {product}
