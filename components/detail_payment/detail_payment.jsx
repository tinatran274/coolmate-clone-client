...
const DetailPayment = (props) => {
    ...
    return (
        <div className="p-8 w-[100%]">
            <p className="text-center text-4xl font-bold my-16">ĐẶT HÀNG THÀNH CÔNG!</p>
            <p className="text-center text-sm">Trên thị trường có quá nhiều sự lựa chọn, cảm ơn bạn đã lựa chọn mua sắm tại 
            <span className='font-bold'> Coolmate.me </span></p>
            <div className="flex justify-center my-8">
                <p className="text-center text-sm w-[70%] ">Đơn hàng của bạn CHẮC CHẮN đã được chuyển tới hệ thống xử lý đơn hàng của Coolmate.
                Trong quá trình xử lý Coolmate sẽ liên hệ lại nếu như cần thêm thông tin từ bạn. Ngoài ra Coolmate cũng sẽ 
                có gửi xác nhận đơn hàng bằng Email và tin nhắn</p>
            </div>
            <p className="text-center text-sm">Tham gia cộng đồng <span className='font-bold'> Mặc Đẹp Sống Chất </span> cùng Coolmate.</p>
            <div className="flex justify-center">
                <Button className='rounded-full text-lg p-8 my-16 hover:bg-blue-500 ' >Khám phá thêm các sản phẩm khác tại đây</Button>
            </div>
