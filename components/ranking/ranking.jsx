...
const Ranking = () => {
    ...
    return (
        <div className='bg-white flex flex-row px-16 py-6 mx-4 rounded-md justify-between items-center'>
            ...
            <div className='w-[60%]'>
                <h2 style={{ fontSize: 40, }}>Hi, TRẦN THỊ HỒNG NHUNG</h2>
                <img className='h-10 object-contain' src="https://mcdn.coolmate.me/image/October2023/mceclip0_92.png" alt="icon"/>
                <div className='flex my-6 items-center'>
                    <p className=''>Chi tiêu thêm <span className='font-bold text-blue-700 my-2'>500.000đ</span> để lên hạng </p>
                    <img className='h-8 object-contain mt-1 ml-1' src="https://mcdn.coolmate.me/image/September2023/mceclip0_56.png" alt="icon"/>
                </div>
            ...
            <div>
                <div className='bg-black flex flex-row justify-between px-4 py-2 rounded-md'>
                    <p className='text-white p-3 text-2xl w-[60%]'>CoolClub Rewards Hub</p>
